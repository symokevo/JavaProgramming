...
public class FindPrice {
	...
	public static void main(String[] args) {
		...
		if(isValidItem)
			JOptionPane.showInternalMessageDialog(null, "The price for item " + itemOrdered + " is $" + itemPrice);
		else
			JOptionPane.showInternalMessageDialog(null, "Sorry - invalid item entered");
