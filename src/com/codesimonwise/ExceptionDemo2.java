...
public class ExceptionDemo2 {
	...
	public static void main(String[] args) {
		...
		try {
			inputString = JOptionPane.showInputDialog(null, "Enter a number to by divided");
		...
		{
			JOptionPane.showInternalMessageDialog(null, "This application accepts digits only!");
			numerator = 999;
			denominator = 999;
			result = 1;
		}
